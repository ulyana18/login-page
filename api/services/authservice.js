...
const pool = require(path.resolve('db/queries'));
const { LOGIN_ERROR, SIGNUP_ERROR, TOKEN_ERROR } = require(path.resolve('messages/userMessages'));
const { TOKEN_LIFE_TIME } = require(path.resolve('messages/consts'));
